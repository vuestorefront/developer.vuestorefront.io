...
declare global {
  ...
  const ContentDoc: typeof import('@nuxt/content')['ContentDoc']
  const ContentList: typeof import('@nuxt/content')['ContentList']
  const ContentNavigation: typeof import('@nuxt/content')['ContentNavigation']
  const ContentQuery: typeof import('@nuxt/content')['ContentQuery']
  const ContentRenderer: typeof import('@nuxt/content')['ContentRenderer']
  ...
  const fetchContentNavigation: typeof import('@nuxt/content')['fetchContentNavigation']
  ...
  const Markdown: typeof import('@nuxt/content')['Markdown']
  ...
  const use: typeof import('h3')['use']
  ...
  const useUnwrap: typeof import('@nuxt/content')['useUnwrap']
