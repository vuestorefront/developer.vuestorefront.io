// Generated using https://mjml.io/try-it-live/k96om72Pp
                  ...
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Lato, Arial;font-size:15px;line-height:1;text-align:left;color:#000000;">
                          <p>Hi <%= name %> <%= surname %>,</p>
                          <p>You scored <b><%= score %>%</b> in <%= quiz_name %> knowledge test. See the results page to share your achievement with others.</p> <% if (passed) { %> <p>Because you scored above <%= badge_minimum_score %>%, you can also <b>claim your free Discord badge by going into the link below.</b></p> <% } %>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:16px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:50px;word-break:break-word;">
                        <p style="border-top:solid 2px #cccccc;font-size:1px;margin:0px auto;width:100%;">
                        </p>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Lato, Arial;font-size:12px;line-height:1;text-align:center;color:#000000;">Vue Storefront Inc, 350 Townsend St Ste 740, San Francisco, CA 941071693, United States</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
