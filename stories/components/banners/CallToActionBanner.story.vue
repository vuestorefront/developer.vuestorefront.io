<template>
  <Story title="Banners/Call To Action" :init-state="initState">
    ...
    <template #controls="{ state }">
      ...
      <HstSelect
        v-model="state.buttonTextColor"
        title="Button Text Color"
        :options="{
          secondary: 'Secondary (Violet)',
      ...
      />
      <HstText v-model="state.buttonLink" title="Button Link" />
      <HstText v-model="state.img" title="Image Src" />
      <HstText v-model="state.imgAlt" title="Image Alt" />
      <HstSelect
        v-model="state.color"
        title="Color"
        :options="{
...
<script setup lang="ts">
  import CallToActionBanner from '~/components/banners/CallToActionBanner.vue';
